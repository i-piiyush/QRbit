  ...
  return (
    <>
      <div className="relative ">
        ...
        <div
          className="hidden md:flex w-[20rem] h-[11rem] rounded-lg relative z-40 bg-black overflow-hidden shadow-2xl 2xl:w-[28rem] 2xl:h-[14rem] animatedCard"
          style={{
            transform: "rotate3d(140, 72, -134, 46deg)",
            perspective: "1000px",
            filter: "drop-shadow(20px 20px 100px rgba(0,128, 0, 0.7))",
          }}
        >
