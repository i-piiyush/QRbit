...
const Card3 = ({ forceDummy = false, user, isLoading }) => {
  ...
  const dummyData = {
    ...
    likes: "19.8M",
    image:
      "https://i.pinimg.com/736x/23/dc/eb/23dcebd983e01b614c1c850e14c6b3e0.jpg",
  ...
  const displayData = useDummyData
    ...
    : {
        ...
        about: user?.about || user?.profession || dummyData.about,
    ...
    <div className="text-white h-[40rem] w-full relative overflow-hidden bg-black flex flex-col items-center rounded-lg">
      ...
      >
        ...
        <div className="flex flex-col justify-between gap-5 items-center mt-5">
          <p className="w-[90%] text-sm tracking-tight">{displayData.about}</p>
