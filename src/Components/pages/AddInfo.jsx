      ...
      case 3:
        return (
          <div>
            ...
            <textarea
              {...register("about", { required: true, maxLength: 270 })}
              className={inputClass}
              placeholder="Tell something about yourself (max 40 words)"
            />
          </div>
        );
      case 4:
      ...
      case 6:
        return (
          <div>
            ...
            <input
              type="number"
              {...register("following", { required: true })}
              className={inputClass}
              placeholder="e.g., 350"
            />
          </div>
        ...
        return (
          <div>
            ...
            <input
              ...
              placeholder="e.g., 600"
            />
            <label className="block mt-4 mb-2 font-semibold text-white">
              Contact Link
            </label>
            <input
              type="url"
