...
const Footer = () => {
  ...
  return (
    <footer
      key={renderKey}
      className="bg-green-400 overflow-hidden rounded-t-[80px] relative z-[999]"
    >
      <div className="bg-green-400 text-black p-8 md:flex md:justify-between md:items-center md:px-16 md:py-12 overflow-hidden">
        <div className="md:flex md:flex-col md:items-start">
          <div className="bg-black text-white px-3 py-3 rounded-full flex items-center relative w-64 overflow-hidden my-10">
            <motion.span
              drag="x"
      ...
      <div className="text-7xl md:text-9xl font-bold mt-8 md:mt-0 md:self-end md:text-6xl py-12 pb-32 md:py-0 flex justify-center items-center relative">
